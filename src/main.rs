    ...
    fn init(c: init::Context) -> init::LateResources {
        ...
        *USB_BUS = Some(UsbBusType::new(usb, EP_MEMORY));
        ...
        let matrix = Matrix::new(
            [
                gpiob.pa10.into_pull_up_input().erase(),
                gpiob.pa15.into_pull_up_input().erase(),
                ...
                gpioa.pb8.into_pull_up_input().erase(),
                gpioa.pb7.into_pull_up_input().erase(),
                gpioa.pa1.into_pull_up_input().erase(),
                gpiob.pa2.into_pull_up_input().erase(),
                gpiob.pa3.into_pull_up_input().erase(),
                gpiob.pa4.into_pull_up_input().erase(),
                gpioa.pb1.into_pull_up_input().erase(),
            ],
            [
                gpioa.pb10.into_push_pull_output().erase(),
                gpioa.pa5.into_push_pull_output().erase(),
                gpioa.pa6.into_push_pull_output().erase(),
                gpiob.pa7.into_push_pull_output().erase(),
