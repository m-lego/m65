## m66 - the lego keyboard
  ...
  ![m66 rev 4](pics/m66/mlege-m66-rev4-sharp.webp){ loading=lazy }
...
!!! info "revisions"
    ...
    + m66 rev4 (formerly m65 rev12) rp2040 promicro pinoout with 2 shift registers HC595, oled/lcd(ST7735 tested)/sharp/eink ssd1680 weact', clickable
      encoder, per key rgb, rgb backlight
...
this is rev4 uk keymaps various layouts, except mouse keys qmk and zmk are identical.

![m66 keymaps](pics/m66/mlego_m66_rev4_uk.svg){loading=lazy}

layer 0, central legend, layer 1 left legends, layer 2 right legends, layer 3 bottom legends.
