...
!!! "warning mcus"
    ...
    * m65 rev5/rev6 rp2040, raspberry pi pico and comptatible,
    ...
    m66 rev 1 suports zmk for both ble and rp2040 versions

    * m66 rev1 xiao nrf52840 https://wiki.seeedstudio.com/XIAO_BLE/

    * m66 rev4 uses rp2040 in promicro pinout... i used specific splinky and helios pinout.
...
=== "layer lwr - 1"
    ...
    ![m66 rev4 layer 0](pics/m66/mlego_m66_uk-1.webp){loading=lazy}

=== "layer rse - 2"

    ![m66 rev4 layer 2](pics/m66/mlego-m66-rev4-LAYOUT_ortho_5x14-uk-2.svg){loading=lazy}

    ![m66 rev4 layer 0](pics/m66/mlego_m66_uk-2.webp){loading=lazy}

=== "layer adjust - 3"

    ![m66 rev4 layer 3](pics/m66/mlego-m66-rev4-LAYOUT_ortho_5x14-uk-3.svg){loading=lazy}

    ![m66 rev4 layer 0](pics/m66/mlego_m66_uk-3.webp){loading=lazy}
