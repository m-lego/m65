...
#. 10 ms seems like a decent scan rate that one can expect, that is 100 fps more than needed for a keyboard oled.
#. I do not understand why max frequency obtained is bigger than the baseline (oled off wpm off)
