...
!!! info "revisions"
    ...
    + rev10 xiao rp2040 with 3 shift registers 2xHC595 and 1xHC189, oled and push rotary encoder with qmk ( actively looking into zmk firmware support for both rp2040 and nrf52840)
