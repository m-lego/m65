...
!!! success  "status: **rev 10** done and tested"
...
!!! info "revisions"
    ...
    + rev11 xiao rp2040 with 3 shift registers 2xHC595 and 1xHC589, oled/eink and push rotary encoder with qmk ( actively looking into zmk firmware support for both rp2040 and nrf52840)
...
!!! info "revision 10"
    ...
    * pogo pins if you want a battery, ** wrong in the pcb **
    * lipo battery if you want to power it by battery, **wrong in the pcb**
