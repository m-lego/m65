...
#### rev 7/8
  ...
  ![pcb rev7 back](pics/m65_pcb_back_rev7.png){ loading=lazy }

  ![pcb rev7 front](pics/m65_pcb_rev7.png){ loading=lazy }
...
#### rev 4
  ...
  ![the pcb version 4 rev3 ](pics/m65-pcb-v4.jpg){ loading=lazy }

  ![the pcb rev4 ](pics/m65-rev4-pcb.jpg){ loading=lazy }

#### rev 3

  version (3) stm32f103 compatible pinout superseeded by version 4 and 401 go for that

  ![the pcb](pics/m65-pcb3.png){ loading=lazy }
