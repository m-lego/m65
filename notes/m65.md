### m65 - the lego keyboard
  ...
  ![m65 rev7 xiao ble](pics/m65-rev7-xiao-ble.webp)
...
#### status: **rev 7** done and tested, see note
...
+ rev7 xiao rp2040 and nrf52840 with 2 shift registers HC595 and no oled, for rp2040 version both qmk and zmk firmware
 ...
 * optional but recommendedm female headers for socketing the mcu.
 * pogo pins if you want a battery
 * lipo batery if you want to power it by battery.
